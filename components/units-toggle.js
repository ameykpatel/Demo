...
export default function UnitsToggle({ units, onUnitsChange }) {
  ...
  return (
    <div className="mt-4">
      <button
        type="button"
        className="text-sm rounded-full hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-500 focus:ring-green-200 dark:focus:ring-white"
        id="toggle-units"
        aria-expanded="false"
        aria-haspopup="true"
      ...
      {isSettingsMenuOpened ? (
        <div
          className="origin-top mt-2 w-48 rounded-md shadow-lg py-1 bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 focus:outline-none hover:bg-gray-200 dark:hover:bg-gray-600"
          role="menu"
        ...
        >
          <ul>
            ...
            >
              Change units
              <br />
              <span className="text-sm text-indigo-500 dark:text-white">
